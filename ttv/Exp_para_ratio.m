...
%%%%%%% Tuning Parater %%%%%%%%%%
ratios = 10.^(-8:0); % all TV weight to be evaluated
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('\gamma_t/\gamma_s','FontSize',20);
ylabel('Performance','FontSize',20,'Color','b');
set(haxes(1),'FontSize',20,'XTick',1:2:N,'XTickLabel',ratios(1:2:N));
set(haxes(2),'FontSize',20,'XTick',1:2:N,'XTickLabel',ratios(1:2:N));
legend('RMSE','CCC');
